...
class MyGlobalPage extends StatefulWidget {
  MyGlobalPage({Key key}) : super(key: key);

  @override
  _MyGlobalPageState createState() => _MyGlobalPageState();
}

class _MyGlobalPageState extends State<MyGlobalPage>
